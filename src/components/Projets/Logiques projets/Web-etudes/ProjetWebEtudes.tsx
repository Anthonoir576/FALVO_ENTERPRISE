...
//* --------------- Projets web etude ----------------------
//* ########################################################
//                 MAPPAGE DES DONNEES DB
//* --------------------------------------------------------
const ProjetWebEtudes = () => {
              ...
              <div className="wrapper">
                ...
                <div className="data">
                  <div className="content">
                    ...
                    <p className="text">{projet.resume}</p>
                    <span className="author">
                      {projet.auteur[0].nom} {projet.auteur[0].prenom}
                    </span>
                    <button
                      className="btn-alert-card"
                      onClick={() => {
...
//~ --------------------- EXPORT ---------------------------
//~ ########################################################
export default ProjetWebEtudes;
//~ --------------------------------------------------------
//~ ########################################################