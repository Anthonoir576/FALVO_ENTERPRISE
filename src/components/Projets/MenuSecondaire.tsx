...
import IconoirInternet                         from "../Icons/IconoirInternet";
import FluentDeveloperBoardLightning20Regular  from "../Icons/FluentDeveloperBoardLightning20Regular";
import IonGameControllerOutline                from "../Icons/IonGameControllerOutline";
    ...
    <>
      <div className="menuSecondaire">
                ...
                menuButton={
                  <MenuButton
                    className={
                      ...
                      ue === false &&
                      logiciel === false
                        ? "active-menuSecondaire szh-menu-button"
                        : "szh-menu-button"
                    }
                    aria-label="Mes projets de développement web"
                    onClick={() => {
                      if (
                        webProjetEtudes === false &&
                        webProjetPro === false &&
                        webProjetSolo === false
                      ) {
                        isActive();
            ...
            <li>
              <Menu
                menuButton={
                  ...
                  >
                    Projet Logiciel <FluentDeveloperBoardLightning20Regular />
                  </MenuButton>
                }
              >
            ...
            <li>
              <Menu
                menuButton={
                  ...
                  >
                    Projet Unreal engine <IonGameControllerOutline />
                  </MenuButton>
                }
              >
                <MenuItem>Projets d'études</MenuItem>
        ...
        <div className="affichage-option-projets">
          ...
          {logiciel === true ? <ProjetLogiciel /> : <></>}

          {ue === true ? <ProjetUnrealEngine /> : <></>}
        </div>
      </div>
    </>
  );
